        ...
        <div class="container-fluid">
          <div class="row page-titles">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a href="javascript:void(0)">Data Wali Kelas</a></li>
            </ol>
          </div>
          <!-- row -->
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
									<a href="../add/addwclass.php" class="btn btn-primary d-sm-inline-block d-none">Add Data</a>
                </div>
                <div class="card-body">
