          ...
          <ul class="metismenu" id="menu">
            <li class="dropdown header-profile">
              <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                <div class="header-info ms-3">
                  <span class="font-w600">Hi,<b><?php echo $_SESSION['fullname']; ?></b></span>
                  <small class="text-start font-w400"><?php echo $_SESSION['username']; ?></small>
                </div>
              </a>
              <div class="dropdown-menu dropdown-menu-end">
                <a href="../auth/logout.php" class="dropdown-item ai-icon">
            ...
            <li>
              ...
              <ul aria-expanded="false">
                ...
                <li><a href="../show/showdatauser.php">Data User</a></li>
                <li><a href="../show/showdatawclass.php">Data Wali Kelas</a></li>
                <li><a href="../show/showdatastudent.php">Data Siswa</a></li>
                <li><a href="../show/showdataspp.php">Data SPP</a></li>
                <li><a href="page-transaction.html">Transaksi</a></li>
              </ul>
            </li>
          </ul>
          <div class="copyright">
            <p><strong>SPP Manager</strong> © 2022 All Rights Reserved</p>
            <p class="fs-12">Made by Afila Ansori</p>
          </div>
        </div>
      </div>
      <!--**********************************
